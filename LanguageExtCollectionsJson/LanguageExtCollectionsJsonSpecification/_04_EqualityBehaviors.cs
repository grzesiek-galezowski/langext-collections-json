...
public class _04_EqualityBehaviors
{
    ...
    {
        var d11 = new DataWithImmutableArray(ImmutableArray<int>.Empty.Add(1).Add(2).Add(3));
        var d12 = new DataWithImmutableArray(ImmutableArray<int>.Empty.Add(1).Add(2).Add(3));
